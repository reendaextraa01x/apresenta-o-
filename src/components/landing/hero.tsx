    ...
    <section className="relative w-full overflow-hidden py-20 md:py-32 lg:py-40">
        ...
        <div className="container relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center md:text-left">
                ...
                <h1 className="font-headline text-4xl font-extrabold tracking-tight lg:text-5xl xl:text-6xl fade-in fade-in-delay-1">
                    Seu Site Profissional em 3 Dias por Apenas <span className="text-primary text-glow">R$ 297</span>
                </h1>
                <p className="text-lg text-muted-foreground md:text-xl fade-in fade-in-delay-2">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start fade-in fade-in-delay-3">
                    <Link href="#cta">
