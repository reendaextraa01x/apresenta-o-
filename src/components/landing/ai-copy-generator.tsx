  ...
  const handleGenerateCopy = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Não foi possível gerar o texto. Tente novamente mais tarde.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="container relative px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12 scroll-animate">
          ...
          <h2 className="font-headline text-3xl font-bold tracking-tighter sm:text-5xl">
            Gere textos para seu site em segundos
          </h2>
          <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Descreva seu negócio e nossa inteligência artificial criará
            sugestões de títulos e textos para a seção principal do seu site.
          </p>
        </div>

        <div className="mx-auto max-w-3xl space-y-6 scroll-animate delay-200">
          <Card className="bg-background/50 border-border/50">
            ...
            <CardContent className="space-y-4">
              ...
              >
                {isLoading ? 'Gerando...' : 'Gerar Texto Mágico'}
              </Button>
            </CardContent>
          </Card>
